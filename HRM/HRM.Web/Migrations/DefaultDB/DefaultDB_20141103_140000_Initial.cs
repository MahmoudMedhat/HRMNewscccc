        ...
        public override void Up()
        {
            this.CreateTableWithId32("Users", "UserId", s => s
                ...
                .WithColumn("IsActive").AsInt16().NotNullable().WithDefaultValue(1)
                 .WithColumn("FingerPrintCode").AsInt32().Nullable()
               
                .WithColumn("HireDate").AsDateTime().Nullable()
                .WithColumn("EducationalQualification").AsAnsiString(400).Nullable()
                .WithColumn("GraduationYears").AsDateTime().Nullable()
                .WithColumn("MilitaryStatus").AsString(80).Nullable()
                .WithColumn("Birthdate").AsDateTime().Nullable()
                .WithColumn("personalidentification").AsInt32().Nullable()
                .WithColumn("PersonalPhoneNumber").AsInt32().Nullable()
                .WithColumn("Address").AsString(100).Nullable()
                .WithColumn("AttendanceDate").AsDateTime().Nullable()
                .WithColumn("departuredate").AsDateTime().Nullable()
                .WithColumn("EmployeeStatus").AsInt16().Nullable()
                .WithColumn("CasualVacancy").AsInt32().Nullable()
                .WithColumn("Regularvacation").AsInt32().Nullable()
                .WithColumn("AnnualLeave").AsInt32().Nullable()


                .WithColumn("MangerID").AsInt32().Nullable().ForeignKey("UsersFK", "Users", "UserId")
                );
