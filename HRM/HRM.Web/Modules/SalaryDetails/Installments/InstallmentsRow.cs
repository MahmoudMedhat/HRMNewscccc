...
namespace HRM.SalaryDetails.Entities
{
    ...
    [ConnectionKey("Default"), Module("SalaryDetails"), TableName("[dbo].[installments]")]
    ...
    public sealed class InstallmentsRow : Row, IIdRow
    {
        ...
        [DisplayName("Installment Values"), Column("installmentValues"), Size(19), Scale(5) , EditLink]
        ...
        //[DisplayName("Installments"), MasterDetailRelation(foreignKey: "id"), NotMapped]
