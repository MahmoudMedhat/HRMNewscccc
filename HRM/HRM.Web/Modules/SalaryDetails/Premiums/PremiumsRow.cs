...
namespace HRM.SalaryDetails.Entities
{
    ...
    [ConnectionKey("Default"), Module("SalaryDetails"), TableName("[dbo].[Premiums]")]
    [DisplayName("Premiums"), InstanceName("Premiums")]
    [ReadPermission("Administration:General")]
    [ModifyPermission("Administration:General")]
    public sealed class PremiumsRow : Row, IIdRow
    {
        ...
        [DisplayName("User"), NotNull, ForeignKey(typeof(UserRow), "UserId"), LeftJoin("jUserList"), NotMapped]
        [FilterUserEditor(Multiple = true /*, FilterField = fldUser.Status.PropertyName, FilterValue =1*/)]
        ...
        [LookupEditor(typeof(PremiumstypeRow))]
        [DisplayName("Bonus type "), Column("premiumType") /*Scale(5)*/, NotNull , ForeignKey("[dbo].[Premiumstype]", "ID"), LeftJoin("JPremium") , TextualField("Pname")]
        public Int32? premiumType
        {
            get { return Fields.premiumType[this]; }
            set { Fields.premiumType[this] = value; }
        }

        [Expression("JPremium.[Premium]") , DisplayName(" Bonus")]
        public String Pname
        {
        ...
        [DisplayName("Bonus Quantity"), Column("Premium_Quantity"), Size(19), Scale(5), NotNull]
        public Decimal? PremiumQuantity
        {
            get { return Fields.PremiumQuantity[this]; }
            set { Fields.PremiumQuantity[this] = value; }
        }

        [DisplayName("Bonus Date"), Column("Premium_Date"), NotNull]
        public DateTime? PremiumDate
        {
            get { return Fields.PremiumDate[this]; }
            set { Fields.PremiumDate[this] = value; }
        }
        ...
        public class RowFields : RowFieldsBase
        {
            ...
            public DecimalField PremiumQuantity;
            public DateTimeField PremiumDate;
