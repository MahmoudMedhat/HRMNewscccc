...
namespace HRM.SalaryDetails.Entities
{
    ...
    [ConnectionKey("Default"), Module("SalaryDetails"), TableName("[dbo].[EmpLoans]")]
    ...
    public sealed class EmpLoansRow : Row, IIdRow, INameRow
    {
        ...
        [DisplayName("Loan Reason"), Size(255), NotNull, QuickSearch]
        ...
        [DisplayName("Installments"), MasterDetailRelation(foreignKey: "Loanid"), NotMapped , Required]
