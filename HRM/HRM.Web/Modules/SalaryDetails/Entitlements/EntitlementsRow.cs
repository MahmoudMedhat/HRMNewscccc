...
namespace HRM.SalaryDetails.Entities
{
    ...
    [ConnectionKey("Default"), Module("SalaryDetails"), TableName("[dbo].[Entitlements]")]
    [DisplayName("Entitlements"), InstanceName("Entitlements")]
    [ReadPermission("Administration:General")]
    [ModifyPermission("Administration:General")]
    public sealed class EntitlementsRow : Row, IIdRow, INameRow
    {
        ...
        [DisplayName("User"), NotNull, ForeignKey(typeof(UserRow), "UserId"), LeftJoin("jUserList"), FilterUserEditor(Multiple = true), NotMapped]
        ...
        [DisplayName("Entitlement"), Size(19), Scale(5)]
        public Decimal? Entitlement
        {
            get { return Fields.Entitlement[this]; }
            set { Fields.Entitlement[this] = value; }
        }

        [DisplayName("Entitlements Date")]
        public DateTime? EntitlementsDate
        {
            get { return Fields.EntitlementsDate[this]; }
            set { Fields.EntitlementsDate[this] = value; }
        }

        [DisplayName("Entitlement Reason"), Size(150), QuickSearch]
        public String EntitlementReason
        {
            get { return Fields.EntitlementReason[this]; }
            set { Fields.EntitlementReason[this] = value; }
        }
        ...
        {
            get { return Fields.EntitlementReason; }
        }

        public static readonly RowFields Fields = new RowFields().Init();

        public EntitlementsRow()
            : base(Fields)
        {
        }
        ...
        public class RowFields : RowFieldsBase
        {
            ...
            public DecimalField Entitlement;
            public DateTimeField EntitlementsDate;
            public StringField EntitlementReason;
