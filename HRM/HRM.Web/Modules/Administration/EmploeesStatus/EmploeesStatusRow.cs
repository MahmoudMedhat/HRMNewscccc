...
namespace HRM.Administration.Entities
{
    ...
    [ConnectionKey("Default"), Module("Administration"), TableName("[dbo].[EmploeesStatus]")]
    [DisplayName("Emploees Status"), InstanceName("Emploees Status")]
    [ReadPermission("Administration:General")]
    [ModifyPermission("Administration:General")]
    public sealed class EmploeesStatusRow : Row, IIdRow
    {
        ...
        [ Column("EmploymentStatusID") , NotNull,ForeignKey("[dbo].[EmploymentStatus]", "id"),LeftJoin("jEmploymentStatus"),TextualField("Status")]
        [LookupEditor(typeof(EmploymentStatusRow))]
        public Int32? EmploymentStatusID
        {
            get { return Fields.EmploymentStatusID[this]; }
            set { Fields.EmploymentStatusID[this] = value; }
        }

        [DisplayName("User Username"), Expression("jEmploymentStatus.[Status]")]
        ...
        [DisplayName("Emp S Date")]
        public DateTime? EmpSDate
        {
            get { return Fields.EmpSDate[this]; }
            set { Fields.EmpSDate[this] = value; }
        }
        ...
        public class RowFields : RowFieldsBase
        {
            ...
            public Int32Field EmploymentStatusID;
        }
    }
}
