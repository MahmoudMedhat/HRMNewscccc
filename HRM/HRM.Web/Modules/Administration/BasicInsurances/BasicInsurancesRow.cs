...
namespace HRM.Administration.Entities
{
    ...
    [ConnectionKey("Default"), Module("Administration"), TableName("[dbo].[BasicInsurances]")]
    [DisplayName("Basic Insurances"), InstanceName("Basic Insurances")]
    [ReadPermission("Administration:General")]
    [ModifyPermission("Administration:General")]
    public sealed class BasicInsurancesRow : Row, IIdRow, INameRow
    {
        ...
        [DisplayName("Insurance"), Size(200), NotNull, QuickSearch]
        ...
        [DisplayName("Insurances Q"), Column("insurancesQ"), Size(19), Scale(5), NotNull]
        ...
        {
            get { return Fields.InsuranceDate[this]; }
            set { Fields.InsuranceDate[this] = value; }
        }
        ...
        {
            get { return Fields.Insurance; }
        }

        public static readonly RowFields Fields = new RowFields().Init();

        public BasicInsurancesRow()
            : base(Fields)
        {
        }
        ...
        public class RowFields : RowFieldsBase
        {
            ...
            public DateTimeField InsuranceDate;
