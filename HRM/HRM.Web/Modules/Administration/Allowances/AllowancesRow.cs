...
namespace HRM.Administration.Entities
{
    ...
    [ConnectionKey("Default"), Module("Administration"), TableName("[dbo].[Allowances]")]
    [DisplayName("Allowances"), InstanceName("Allowances")]
    [ReadPermission("Administration:General")]
    [ModifyPermission("Administration:General")]
    public sealed class AllowancesRow : Row, IIdRow, INameRow
    {
        ...
        [DisplayName("Allowances Descriptions"), Size(100), NotNull, QuickSearch]
        public String AllowancesDescriptions
        {
            get { return Fields.AllowancesDescriptions[this]; }
            set { Fields.AllowancesDescriptions[this] = value; }
        }

        [DisplayName("Allowance"), Size(19), Scale(5), NotNull]
        ...
        [DisplayName("Allowance Date")]
        public DateTime? AllowanceDate
        {
            get { return Fields.AllowanceDate[this]; }
            set { Fields.AllowanceDate[this] = value; }
        }
        ...
        {
            get { return Fields.AllowancesDescriptions; }
        }

        public static readonly RowFields Fields = new RowFields().Init();

        public AllowancesRow()
            : base(Fields)
        {
        }
        ...
        public class RowFields : RowFieldsBase
        {
            ...
            public StringField AllowancesDescriptions;
            public DecimalField Allowance;
            public DateTimeField AllowanceDate;
