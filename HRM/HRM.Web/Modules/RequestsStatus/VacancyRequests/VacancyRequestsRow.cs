...
namespace HRM.RequestsStatus.Entities
{
    ...
    [ConnectionKey("Default"), Module("RequestsStatus"), TableName("[dbo].[VacancyRequests]")]
    ...
    public sealed class VacancyRequestsRow : Row, IIdRow
    {
        ...
        [LookupEditor(typeof(VacanciesRow))]
        [HideOnInsert]
        [HideOnUpdate]
        ...
        [LookupEditor(typeof(StatusRow)), QuickFilter]
        ...
        [HideOnInsert]
        [HideOnUpdate]
        [DisplayName("Is Acceptedby Hr"), Column("IsAcceptedbyHR"), NotNull , QuickFilter]
        ...
        [HideOnInsert]
        [HideOnUpdate]
        [DisplayName("Date From"), NotNull , QuickFilter]
        ...
        [DisplayName("Dateto"), NotNull , QuickFilter]
        [HideOnInsert]
        [HideOnUpdate]
        ...
        [DisplayName("User Username"), QuickFilter, Expression("jUser.[Username]")]
        ...
        [DisplayName("User Manager Id"), Expression("jUser.[MangerID]")]
        ...
        public class RowFields : RowFieldsBase
        {
            ...
            public Int32Field UserManagerId;
